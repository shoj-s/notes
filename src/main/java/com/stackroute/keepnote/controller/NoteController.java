...
public class NoteController {
	...
	*/
	...
	public String addNote(
		...
		newnotes.setNoteId(noteId);
		newnotes.setNoteTitle(noteTitle);
		newnotes.setNoteContent(noteContent);
		newnotes.setNoteStatus(noteStatus);
		newnotes.setCreatedAt(LocalDateTime.now());
		...
		{
			System.out.println(note.getNoteId()+" "+note.getNoteTitle()+" "+note.getNoteContent()+" "+note.getNoteStatus()+" " +note.getCreatedAt());
		}
